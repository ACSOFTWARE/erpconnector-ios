...
@class Contractor;
@class ACInvoiceTableViewCell;
@interface ACInvoiceListVC : UIViewController <UITableViewDataSource, UITableViewDelegate>
...
@property (strong, nonatomic) IBOutlet ACInvoiceTableViewCell *tableCell;
